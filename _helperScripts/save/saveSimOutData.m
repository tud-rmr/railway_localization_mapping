...
%   
%   Author: Hanno Winter
%   Date: 28-Mar-2021; Last revision: 18-Jul-2021

%% Init

if ~exist('simout_data_saved','var') || simout_data_saved == false
    simout_data_saved = false;
    fprintf('Save Simulink output data...');
elseif simout_data_saved
    fprintf('Already saved Simulink output data!\n');
    return  
end % if
...
if ~insert_gps_outages
    specifier_str = 'simout_';
else
    specifier_str = 'simout_atf_'; % 'atf' like artificial
end % if
...
regexp_str = [ ...
               '.*sim.*|', ... 
               'p_0_utm|', ... 
               'optimization_imm_data_selector|', ... 
               'optimization_gps_data_selector' ... 
             ];
