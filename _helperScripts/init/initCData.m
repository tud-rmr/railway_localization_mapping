...
%   
%   Author: Hanno Winter
%   Date: 20-Mar-2021; Last revision: 08-Apr-2021

%% Load data

loadCFilenamePatterns
importCParameters      
importCLimitedProcessedData
...
% gnss_data = eval(gnss_thales_processed_data_root_string);
% gnss_parameters = eval(gnss_thales_parameters_root_string);
